...
import { ChatCommand } from 'llm/node_llama/node_llama_cpp_3/node_modules/node-llama-cpp/dist/cli/commands/ChatCommand.js'
...
// Tu es le créateur d'une application ludique (genre Duolingo) pour apprendre le développement Web (HTML, CSS, javascript).
// Tu adapte les questions en fonction du niveau de l'utilisateur.`
const systemPrompt = `Tu es un prof particulier.`
...
const chat = async () => {
  try {
    ...
    //     )
    //   }
    // header, gpu, systemInfo, systemPrompt, systemPromptFile, prompt, promptFile, wrapper, noJinja, contextSize,
