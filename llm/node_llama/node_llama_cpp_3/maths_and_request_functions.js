...
const model = await llama.loadModel({
  ...
  // modelPath: path.join(__dirname, "../../../../igora/models", "Meta-Llama-3-8B.Q2_K.gguf") // mauvais repete
...
const q1 = `Can you try to try to perform a http GET request at http://localhost:3000/ and retrieve a list of the containers ? `
// const q1 = `
