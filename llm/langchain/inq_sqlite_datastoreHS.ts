...
let config = {
  configurable: { thread_id: 'conversation_1', checkpoint_ns: 'memories', userId: 'user_1' }
}
let threads = {}
let users = {}
...
console.log("'/s' pour save")
console.log("'/u' pour load")
console.log("'/h' pour history")
      ...
      if (answer == 'exit') {
        ...
        switch (answer.substring(0, 3)) {
          ...
          case '/h':
            ...
            console.log(await graph.getStateHistory(config))
            break
          default:
            console.log('default')
