  ...
  <div>
    ...
    <b-container v-if="node['ve:type'] == 'node'">
      ...
      <b-row v-if="field != null" class="mt-3">
        ...
        <b-col sm="9">
          <b-button variant="outline-secondary" size="sm" @click="clear_field"
            >X</b-button
          >
        </b-col>
      </b-row>
      ...
      <b-row>
        <b-col> </b-col>
        <b-col>
          <b-btn variant="outline-primary" size="sm" @click="add"
            >+ add a property or a link</b-btn
          >
        </b-col>
      </b-row>
      <b-row>
...
import CKWysiwyg from "@/views/CKWysiwyg.vue";
